...
(1) BLAST ITS sequences against whole genomes
(2) Extract rDNA regions surrounding ITS hits
(3) Correct strand orientation (reverse complement if needed)
(4) Use ITSx to identify SSU / ITS / LSU boundaries
(5) Generate annotated GenBank files
